...
public class YoutubeTrendingMovieExtractor extends KioskExtractor<StreamInfoItem> {
    private JsonObject initialData;

    public YoutubeTrendingMovieExtractor(final StreamingService service,
    ...
    public void onFetchPage(@Nonnull final Downloader downloader)
        ...
        final byte[] body = JsonWriter.string(prepareDesktopJsonBuilder(getExtractorLocalization(),
                getExtractorContentCountry())
                        ...
                        .value("params", "4gIKGgh0cmFpbGVycw%3D%3D") // Equal to videos
                .done())
