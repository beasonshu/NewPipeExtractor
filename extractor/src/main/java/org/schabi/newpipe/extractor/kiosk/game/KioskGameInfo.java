package org.schabi.newpipe.extractor.kiosk.game;
...
public final class KioskGameInfo extends ListInfo<StreamInfoItem> {
    private KioskGameInfo(final int serviceId, final ListLinkHandler linkHandler, final String name) {
     ...
     */
    public static KioskGameInfo getInfo(final KioskExtractor extractor) throws ExtractionException {

        final KioskGameInfo info = new KioskGameInfo(extractor.getServiceId(),
