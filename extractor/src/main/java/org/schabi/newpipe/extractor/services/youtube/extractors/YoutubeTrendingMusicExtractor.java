...
public class YoutubeTrendingMusicExtractor extends KioskExtractor<StreamInfoItem> {
    private JsonObject initialData;

    public YoutubeTrendingMusicExtractor(final StreamingService service,
    ...
    public void onFetchPage(@Nonnull final Downloader downloader)
        ...
        final byte[] body = JsonWriter.string(prepareDesktopJsonBuilder(getExtractorLocalization(),
                getExtractorContentCountry())
                        ...
                        .value("params", "4gINGgt5dG1hX2NoYXJ0cw%3D%3D") // Equal to videos
                .done())
