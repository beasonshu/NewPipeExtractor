...
public abstract class KioskMusicExtractor<T extends InfoItem> extends ListExtractor<T> {
    private final String id;

    public KioskMusicExtractor(final StreamingService streamingService,
